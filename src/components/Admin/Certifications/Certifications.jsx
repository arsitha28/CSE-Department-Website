                            ...
                            <div class="card-body">
                                ...
                                <div class="account-settings">
                                    <div class="user-profile">
                                        ...
                                        <h4 class="user-name">Riya</h4>
                                        
                                        <h6 class="user-email">riya123@gmail.com</h6>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div id="accordion" class="accordion">
                                            <div class="card mb-0">
                                                ...
                                                <div id="collapseOne" class="card-body collapse" data-parent="#accordion"  style={{marginLeft:'40px'}}>
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="form-group">
                                                            <label for="Street"> Certificate Name : </label>
                                                            <input type="name" class="form-control" id="Street" placeholder="Enter certificate name"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
