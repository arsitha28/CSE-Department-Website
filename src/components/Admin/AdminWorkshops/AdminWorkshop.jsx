      ...
      <div class="container">
        ...
        <section id="secA">
          ...
          <form onSubmit={this.handleSubmit}>
            <label for="Faculty Name" class="mr-sm-2">
              Faculty Name:
            </label>
            <input
              type="text"
            ...
            <label for="Domain" class="mr-sm-2">
              Domain:
            </label>
            <input
              type="text"
            ...
            <label for="From_Date" class="mr-sm-2">
              From Date:
            </label>
            <input
              type="text"
            ...
            <label for="To_Date" class="mr-sm-2">
              To Date:
            </label>
            <input
              type="text"
