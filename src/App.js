...
const AdminContainer = () => (
  <React.Fragment>
    ...
    <Route
      path="/admin/AdminComplaintBox"
      exact
      component={AdminComplaintBox}
    />
    <Route path="/admin/AdminResearch" exact component={AdminResearch} />
    <Route
      path="/admin/AdminStudentCorner"
      exact
      component={AdminStudentCorner}
    />
...
const TestContainer = () => <React.Fragment></React.Fragment>;
